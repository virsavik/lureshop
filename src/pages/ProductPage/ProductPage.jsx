...
import { Card, CardImg, CardBody, CardTitle, CardSubtitle, CardText, Button, Row, Col, Spinner } from 'reactstrap';
            ...
            <Col key={index}>
              <Card style={{ margin: '5px'}}>
                <div style={{ textAlign: 'right', padding: '10px'}}>
                  <Button style={{ backgroundColor: 'transparent', border: 'none' }} onClick={() => likeProduct(product)}>
